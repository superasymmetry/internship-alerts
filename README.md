...
4,551 employers tracked · data as of Sep 12, 2026 at 21:39 UTC
...
_Engine (last run): 4,459 of 4,803 registered boards returned successfully across 13 ATS platforms (99% of boards attempted, 92% of the full registry) · completed in 886.2s · 598 board(s) returned a capped result set, so their roles were not eligible to be closed this run · employer or source-derived date on 99% of open roles._
